...
class Simulator():
	...
	def render(self, trial, testing = False):
		...
		self.font = self.pygame.font.Font(None, 30)
		self.screen.blit(self.font.render("Number of U-turns: %s" %(self.env.wrong_route_count), True, self.colors['blue'], self.bg_color), (10,150))
		
		self.font = self.pygame.font.Font(None, 30)
		self.screen.blit(self.font.render("Number of Wrong route entries: %s" %(self.env.), True, self.colors['blue'], self.bg_color), (10,150))
